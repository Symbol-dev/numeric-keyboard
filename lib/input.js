...
export const Mixins = {
  ...
  openKeyboard() {
    ...
    const elKeyboardSpace = document.createElement('div')
    ...
    const keyboardAreaHeight = height * 0.36
    window.scroll({ top: height - keyboardAreaHeight, behavior: 'smooth' })
  },
  ...
  closeKeyboard() {
    ...
    const elKeyboardSpace = this.ks.keyboardSpaceElement
